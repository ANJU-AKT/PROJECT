...
def report(request,uid):
    ...
    q1="select * from analyse where stid='"+uid+"'"
    d1=dbconnection.selectalldata(q1)    
    return render(request,'office/report.html',{'st':data,'d1':d1})
        ...
        for (x, y, w, h) in faces:
            ...
            if(chdata):
                if(chdata[2]==val):
                    ...
                    qry="INSERT INTO `analyse`(`stid`, `emo`, `emoval`, `dt`) VALUES ('"+str(uid)+"','"+emotion_dict[maxindex]+"','"+str(x)+"','"+today+"')" 
                    dbconnection.insertdata(qry)  
                    print(emotion_dict[maxindex]) 
                    i=i+1
                    print(i)
        ...
        for (x, y, w, h) in faces:
            ...
            if(chdata):
                if(chdata[2]==val):
                    ...
                    x=1
                    qry="INSERT INTO `analyse`(`stid`, `emo`, `emoval`, `dt`) VALUES ('"+str(data[0])+"','"+emotion_dict[maxindex]+"','"+str(x)+"','"+today+"')" 
                    dbconnection.insertdata(qry)  
                    print(emotion_dict[maxindex]) 
                    i=i+1
                    print(i)
